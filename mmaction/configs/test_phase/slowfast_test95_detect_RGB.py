...
data_root = '/home/GaoXiang/program_file/AUTSL/mmaction/data/AUTSL/test/rawframes_align'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='slowfast_pseudo95_RGB.csv',
...
log_level = 'INFO'
work_dir = './work_dirs_testphase/slowfast_detect_RGB'
load_from = None
resume_from = None
