...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='/home/GaoXiang/program_file/AUTSL/mmaction/data/AUTSL/train/train_val_test93_depth_rawframes.csv',
...
log_level = 'INFO'
work_dir = './work_dirs_testphase/slowonly_addvalset_testset93_lr0.01_cropratio0.08_epoch80_depth'
load_from = None
resume_from = "work_dirs_testphase/slowonly_addvalset_testset93_lr0.01_cropratio0.08_epoch80_depth/epoch_5.pth"

'''
config:
不框人全图输入，RandomCrop的比例为（0.08，1），初始lr为0.01，epoch80,加上验证集和测试集93的伪标签一起训练,depth数据
'''