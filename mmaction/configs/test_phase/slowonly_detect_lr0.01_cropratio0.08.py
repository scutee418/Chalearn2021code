...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='/home/GaoXiang/program_file/AUTSL/mmaction/data/AUTSL/train/train_RGB_rawframesalign.csv',
    ...
    val=dict(
        type=dataset_type,
        ann_file='/home/GaoXiang/program_file/AUTSL/mmaction/data/AUTSL/val/val_RGB.csv',
        ...
        afterdetect_resize=(280,320),
        RandomResizeCrop_scale=(0.9, 1.0)
        ),
   test=dict(
        type=dataset_type,
        ann_file='/home/GaoXiang/program_file/AUTSL/mmaction/data/AUTSL/val/val_RGB.csv',
...
log_level = 'INFO'
work_dir = './work_dirs_testphase/slowonly_detect_lr0.01_cropratio0.08'
load_from = None
resume_from = None
