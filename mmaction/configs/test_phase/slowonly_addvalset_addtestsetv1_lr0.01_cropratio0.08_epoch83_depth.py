...
log_level = 'INFO'
work_dir = './work_dirs_testphase/slowonly_addvalset_addtestsetv1_lr0.01_cropratio0.08_epoch83_depth'
load_from = None
resume_from = "work_dirs_testphase/slowonly_addvalset_addtestsetv1_lr0.01_cropratio0.08_epoch83_depth/epoch_77.pth"

'''
config:
不框人全图输入，RandomCrop的比例为（0.08，1），初始lr为0.01，epoch80,加上验证集一起训练,depth数据
'''