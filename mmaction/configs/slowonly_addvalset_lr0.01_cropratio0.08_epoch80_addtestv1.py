...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='/data/GaoXiang/program_file/AUTSL/mmaction/data/AUTSL/train/train_val_testv1_RGB_rawframes.csv',
...
log_level = 'INFO'
work_dir = './work_dirs_testphase/slowonly_addvalset_lr0.01_cropratio0.08_epoch80_addtestv1_lrstartfrom0.001'
load_from = None
resume_from = None
