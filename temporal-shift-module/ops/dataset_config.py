...
def return_AUTSL(modality):
    filename_categories = 226
    if modality == 'RGB':
        # root_data = '/home/GaoXiang/program_file/AUTSL/mmaction/data/AUTSL'
        root_data = '/home/GaoXiang/program_file/AUTSL/mmaction/data/AUTSL/test/rawframes_align'
        filename_imglist_train = '/home/GaoXiang/program_file/AUTSL/mmaction/data/AUTSL/train/train_val_testv1_RGB_rawframes.csv'
        filename_imglist_val = '/home/GaoXiang/program_file/AUTSL/mmaction/data/AUTSL/train/train_val_testv1_RGB_rawframes.csv'
        filename_imglist_test = '/home/GaoXiang/program_file/AUTSL/mmaction/data/AUTSL/AUTSL_file_list2.csv'
        prefix = 'img_{:05d}.jpg'
    elif modality == 'Flow':
        # root_data = ROOT_DATASET + 'something/v2/20bn-something-something-v2-flow'
        
        'for RGB optical flow'
        # root_data = '/home/GaoXiang/program_file/AUTSL/mmaction/data/AUTSL'
        root_data = '/home/GaoXiang/program_file/AUTSL/mmaction/data/AUTSL/test/optical_flow'
        filename_imglist_train = '/home/GaoXiang/program_file/AUTSL/mmaction/data/AUTSL/train/train_val_testv1_RGB_opticalflow.csv'
        filename_imglist_val = '/home/GaoXiang/program_file/AUTSL/mmaction/data/AUTSL/train/train_val_testv1_RGB_opticalflow.csv'
        filename_imglist_test = '/home/GaoXiang/program_file/AUTSL/mmaction/data/AUTSL/test/test_RGB_pse93.csv'

        # 'for depth optical flow'
        # # root_data = '/data/GaoXiang/program_file/AUTSL/mmaction/data/AUTSL/train'
        # root_data = '/data/GaoXiang/program_file/AUTSL/mmaction/data/AUTSL/val/optical_flow'
        # filename_imglist_train = '/data/GaoXiang/program_file/AUTSL/mmaction/data/AUTSL/train/train_depth_opticalflow.csv'
        # filename_imglist_val = '/data/GaoXiang/program_file/AUTSL/mmaction/data/AUTSL/train/train_depth_opticalflow.csv'
        # filename_imglist_test = '/data/GaoXiang/program_file/AUTSL/mmaction/data/AUTSL/val/test_depth_opticalflow.csv'
